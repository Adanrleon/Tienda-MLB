  ...
  return (
    <footer className="mt-24 border-t border-slate-200 bg-white">
      <div className="mx-auto max-w-[90rem] px-4 py-16 sm:px-6 lg:px-10">
        <div className="grid gap-12 md:grid-cols-[2fr_1fr_auto]">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="text-slate-400 transition-colors hover:text-mlb-red"
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col gap-3 text-sm font-medium text-slate-600">
              <Link href="/catalog?category=Home" className="hover:text-mlb-red transition-colors">Home</Link>
              <Link href="/catalog?category=Away" className="hover:text-mlb-red transition-colors">Away</Link>
              <Link href="/catalog?category=City Connect" className="hover:text-mlb-red transition-colors">City Connect</Link>
              <Link href="/catalog?category=Alternative" className="hover:text-mlb-red transition-colors">Alternative</Link>
              <Link href="/catalog?category=Throwback" className="hover:text-mlb-red transition-colors">Throwback</Link>
            </nav>
          </div>

          <div className="space-y-4">
            <p className="caps-label">We Accept</p>
            <nav className="flex items-center gap-4 opacity-50 grayscale">
